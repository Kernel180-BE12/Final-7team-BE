...
public class EmailVerification {
    ...
    public EmailVerification(Long emailVerificationId, String email, String verificationCode,
                           LocalDateTime expiredAt, Boolean isVerified, LocalDateTime verifiedAt,
